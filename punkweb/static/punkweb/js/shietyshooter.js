...
var GameState = (function (_super) {
    ...
    function GameState(gameCtx) {
        ...
        _this.characterSprite1.src = 'https://punkweb.net/static/punkweb/js/assets/shietyshooter/character-right.png';
        _this.characterSprite2 = new Image();
        _this.characterSprite2.src = 'https://punkweb.net/static/punkweb/js/assets/shietyshooter/character-left.png';
        _this.grassSprite = new Image();
        _this.grassSprite.src = 'https://punkweb.net/static/punkweb/js/assets/shietyshooter/grass.png';
        _this.dirtSprite = new Image();
        _this.dirtSprite.src = 'https://punkweb.net/static/punkweb/js/assets/shietyshooter/dirt.png';
        _this.skySprite = new Image();
        _this.skySprite.src = 'https://punkweb.net/static/punkweb/js/assets/shietyshooter/clouds.jpg';
        _this.song = new Audio('https://punkweb.net/static/punkweb/js/assets/shietyshooter/Shiety_Blues-JackStraw.mp3');
